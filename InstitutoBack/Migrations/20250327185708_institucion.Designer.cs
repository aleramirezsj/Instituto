...
namespace InstitutoBack.Migrations
{
    ...
    [Migration("20250327185708_institucion")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InstitutoServices.Models.Commons.Institucion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CodigoPostal = "3040",
                            Direccion = "Bv. Patria, Bv. Libertad y calle las Magnolias",
                            Email = "secretariaisp20@gmail.com",
                            Localidad = "San Justo",
                            NombreCompleto = "Instituto Superior de Profesorado N° 20 \"Senador Nestor Juan Zamaro\"",
                            NombreCorto = "Instituto Superior de Profesorado N°20",
                            Provincia = "Santa Fe",
                            Sigla = "ISP20",
                            Telefono = "3498 15526026"
                        });
                });
            ...
            modelBuilder.Entity("InstitutoServices.Models.Commons.Usuario", b =>
                {
                    ...
                    b.Property<bool>("PermitirAccionesAdministrativas")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Nombre = "admin",
                            Password = "",
                            PermitirAccionesAdministrativas = false,
                            TipoUsuario = 4
                        });
                });
            ...
            modelBuilder.Entity("InstitutoServices.Models.Inscripciones.Inscripcion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CarreraId = 1,
                            Eliminado = false,
                            Fecha = new DateTime(2025, 3, 27, 15, 57, 7, 803, DateTimeKind.Local).AddTicks(5253),
            ...
            modelBuilder.Entity("InstitutoServices.Models.Inscripciones.DetalleInscripcion", b =>
                {
                    b.HasOne("InstitutoServices.Models.Inscripciones.Inscripcion", "Inscripcion")
                        .WithMany("detallesInscripciones")
            ...
            modelBuilder.Entity("InstitutoServices.Models.MesasExamenes.DetalleInscripcionExamen", b =>
                {
                    b.HasOne("InstitutoServices.Models.MesasExamenes.InscripcionExamen", "InscripcionExamen")
                        .WithMany("detallesInscripcionesExamenes")
            ...
            modelBuilder.Entity("InstitutoServices.Models.Inscripciones.Inscripcion", b =>
                {
                    b.Navigation("detallesInscripciones");
                });

            modelBuilder.Entity("InstitutoServices.Models.MesasExamenes.InscripcionExamen", b =>
                {
                    b.Navigation("detallesInscripcionesExamenes");
                });
